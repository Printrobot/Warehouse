...
const translations = {
  en: {
    ...
    "dashboard.orders.desc": "Manage active and completed orders, track boxes.",
    "dashboard.analytics.title": "Analytics",
    "dashboard.analytics.desc": "View analytics, user reports, and shipping manifests.",
    ...
    "nav.move_boxes": "Move Boxes",
    "dashboard.move.title": "Move Boxes",
    "dashboard.move.desc": "Relocate boxes between warehouse shelves and split orders.",
  ...
  ru: {
    ...
    "nav.orders": "Управление заказами",
    "nav.analytics": "Аналитика",
    "nav.users": "Пользователи",
    "nav.settings": "Настройки",
    "nav.history": "История",
    "nav.reports": "Отчет по отгрузкам",
    "nav.logout": "Выйти",
    ...
    "dashboard.orders.desc": "Управление активными и завершенными заказами, отслеживание коробок.",
    "dashboard.analytics.title": "Аналитика",
    "dashboard.analytics.desc": "Аналитика, отчеты по пользователям и погрузочные манифесты.",
    ...
    "nav.move_boxes": "Переместить коробки",
    "dashboard.move.title": "Перемещение коробок",
    "dashboard.move.desc": "Переместить коробки между полками склада, расщепить заказ.",
    "nav.locations": "Места на складе",
